//UIUC CS125 FALL 2012 MP. File: ImageUtilities.java, CS125 Project: Challenge4-Photoscoop, Version: 2012-10-03T12:48:42-0500.607852000
...
public class ImageUtilities {
	...
	public static BufferedImage loadImage(String filename) {
		try {
			...
			System.out.println(ImageIO.read(GUI.class.getResourceAsStream(filename)));
			return ImageIO.read(GUI.class.getResourceAsStream(filename));
		} catch (Exception e) {
		}
		try {
